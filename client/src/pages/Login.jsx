...
const Login = () => {
	...
	return (
		<div className="min-h-screen flex items-center justify-center bg-[#1e1f22] p-4">
			...
			>
				<h1 className="text-center text-3xl font-bold mb-6">login karo</h1>
				...
				<form onSubmit={handleLogin} className="space-y-5">
					...
					<div className="text-right text-xs text-zinc-400 hover:underline cursor-pointer">
						Forgot password?
					</div>

					<button
						type="submit"
						className="w-full bg-blue-600 hover:bg-blue-700 transition duration-300 py-2 rounded-lg flex items-center justify-center gap-2 font-medium"
					>
